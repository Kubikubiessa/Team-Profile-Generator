...
function addEmployee() {
  return (
    inquirer
      ...
      //once the basic information is collected, the following if-statement will add role-specific information based on the entered roles and another CLI prompt will ask for the respective role information and whether another employee should be added to the array (page).
      .then(({ name, id, email, role }) => {
        ...
        inquirer
          ...
          //then the array objects will be completed, including if statement to sort employee roles based on prompt input and subclass and to push them into the employee array.
